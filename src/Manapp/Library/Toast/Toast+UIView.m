...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.frame = CGRectMake(20, 0.0, expectedSizeTitle.width, expectedSizeTitle.height);
    }
    ...
    if(titleLabel != nil) {
        // Edit position of title
        titleLabel.frame = CGRectMake(titleLeft + 60, titleTop, titleWidth, titleHeight);
