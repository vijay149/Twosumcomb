...
+ (BOOL)saveImage:(UIImage *) image toDocumentWithName:(NSString *)name{
    NSString *documentPath = [FileUtil pathForPathType:PathTypeDocument];
    NSString  *pngPath = [documentPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.png",name]];
