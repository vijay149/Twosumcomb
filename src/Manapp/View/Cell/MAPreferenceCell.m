...
@implementation MAPreferenceCell
...
+ (CGFloat)cellHeightForName:(NSString *)name {
    ...
    CGFloat commentWidth = 302;
    UIFont *commentFont = [UIFont fontWithName:kAppFont size:19];
    CGSize commentSize = [name sizeWithFont:commentFont constrainedToSize:CGSizeMake(commentWidth, 20000) lineBreakMode: NSLineBreakByWordWrapping];
